...
const isLeftCol = (isEvenRow && number % 10 === 0) || (!isEvenRow && number % 10 === 1);


const isRightCol = (isEvenRow && number % 10 === 1) || (!isEvenRow && number % 10 === 0);
 ...
 const Board = () => {
   ...
   let ladderPipes = {
    "1": {
        ...
        "b": { orient:"straight-vertical-1b", position:{ row: 8, col: 2 } , height: "9.9rem", width:".5rem" , top:"", left:"-.3rem" },
        "c": { orient:"straight-horizontal-1c", position:{ row: 8, col: 2 } , height: ".5rem", width:"5.95rem" , top:"-0.32rem", left:"-0.3rem" },
        "d": { orient:"vertical-1d", position:{ row: 7, col: 3 } , height: "1.85rem", width:".5rem" , top:"2.38rem", left:"1.7rem" },
        },
    "4":{
        "a": { orient:"horizontal-4a", position:{ row: 10, col: 4 } , height: ".5rem", width:"1.8rem", top:"1.7rem", left:"2.2rem"  },
        "b": { orient:"straight-vertical-4b", position:{ row: 9, col: 5 } , height: "6.63rem", width:".5rem" , top:"-0.37rem", left:"-.2rem" },
        ...
        "e": { orient:"horizontal-4e", position:{ row: 10, col: 6 } , height: ".5rem", width:"1.8rem", top:"-0.45rem", left:"4rem"  },
    ...
    "9":{
        ...
        "b": { orient:"straight-vertical-9b", position:{ row: 8, col: 9 } , height: "10.3rem", width:".5rem" , top:"", left:"-.3rem" },
        "c": { orient:"straight-horizontal-9c", position:{ row: 8, col: 9 } , height: ".5rem", width:"6rem" , top:"-0.32rem", left:"-0.3rem" },
        "d": { orient:"vertical-9d", position:{ row: 7, col: 10 } , height: "1.85rem", width:".5rem" , top:"2.37rem", left:"1.7rem" },
        },
    "28":{
        "a": { orient:"horizontal-28a", position:{ row: 8, col: 7 } , height: ".5rem", width:"2rem", top:"1.7rem", left:"4rem"  },
        "f": { orient:"vertical-28f", position:{ row: 7, col: 7 } , height: "2.54rem", width:".5rem" , top:"3.7rem", left:"3.7rem" },
        "c": { orient:"straight-horizontal-28c", position:{ row: 8, col: 6 } , height: ".5rem", width:"8rem" , top:"-.35rem", left:"0rem" },
        "b": { orient:"straight-vertical-28b", position:{ row: 3, col: 6 } , height: "20.77rem", width:".5rem" , top:"-0.35rem", left:"-.2rem" },
    ...
    "36":{
        ...
        "c": { orient:"straight-horizontal-36c", position:{ row: 7, col: 4 } , height: ".5rem", width:"2.15rem" , top:"-0.38rem", left:"2.05rem" },
        "d": { orient:"vertical-36d", position:{ row: 6, col: 4 } , height: "1.85rem", width:".5rem" , top:"2.33rem", left:"1.7rem" },
        },
    "40":{
        "a": { orient:"horizontal-40a", position:{ row: 7, col: 1 } , height: ".5rem", width:"2rem", top:"1.7rem", left:"2.15rem"  },
        ...
        "d": { orient:"vertical-40d", position:{ row: 6, col: 2 } , height: "1.85rem", width:".5rem" , top:"2.35rem", left:"1.7rem" },
        },
    "51":{
        "a": { orient:"horizontal-51a", position:{ row: 5, col: 9 } , height: ".5rem", width:"2rem", top:"1.7rem", left:"4rem"  },
        "f": { orient:"vertical-51f", position:{ row: 4, col: 9 } , height: "2.58rem", width:".5rem" , top:"3.66rem", left:"3.7rem" },
        "c": { orient:"straight-horizontal-51c", position:{ row: 5, col: 8 } , height: ".5rem", width:"10rem" , top:"-.35rem", left:"-2rem" },
        "d": { orient:"vertical-51d", position:{ row: 4, col: 7 } , height: "1.85rem", width:".5rem" , top:"2.35rem", left:"1.7rem" },
        },
    "71":{
        "a": { orient:"horizontal-71a", position:{ row: 3, col: 9 } , height: ".5rem", width:"2rem", top:"1.7rem", left:"3.75rem"  },
        ...
        "b": { orient:"horizontal-71b", position:{ row: 1, col: 9 } , height: ".5rem", width:"2rem", top:"3.7rem", left:"3.75rem"  },
        },
    "80":{
        "a": { orient:"horizontal-80a", position:{ row: 3, col: 1 } , height: ".5rem", width:"2rem", top:"1.7rem", left:"2.25rem"  },
        "c": { orient:"straight-vertical-80c", position:{ row: 2, col: 2 } , height: "6.38rem", width:".5rem" , top:"-0.24rem", left:"-.2rem" },
        "b": { orient:"horizontal-80b", position:{ row: 1, col: 1 } , height: ".5rem", width:"2.25rem", top:"3.7rem", left:"2rem"  },
    ...
    let snakePipes = {
        "6":{
            ...
            "a": { orient:"horizontal-6a", position:{ row: 10, col: 6 } , height: ".5rem", width:"2rem", top:"-0.45rem", left:"0rem"  },
        ...
        "11":{
            "d": { orient:"vertical-11d", position:{ row: 8, col: 10 } , height: "2rem", width:".5rem" , top:"3.72rem", left:"1.7rem" },
            "a": { orient:"horizontal-11a", position:{ row: 9, col: 10 } , height: ".5rem", width:"2rem", top:"-0.34rem", left:"0rem"  },
            "b": { orient:"straight-vertical-11b", position:{ row: 6, col: 10 } , height: "10.37rem", width:".5rem" , top:"1.95rem", left:"-.2rem" },
        ...
        "19":{
            ...
            "a": { orient:"horizontal-19a", position:{ row: 9, col: 2 } , height: ".5rem", width:"2rem", top:"-0.43rem", left:"2rem"  },
            "b": { orient:"straight-vertical-19b", position:{ row: 4, col: 3 } , height: "18.65rem", width:".5rem" , top:"1.7rem", left:"-.3rem" },
        ...
        "24":{
            ...
            "b": { orient:"horizontal-24b", position:{ row: 8, col: 4 } , height: ".5rem", width:"2rem", top:"-0.43rem", left:"0rem"  },
            "c": { orient:"straight-vertical-24c", position:{ row: 4, col: 4 } , height: "12.3rem", width:".5rem" , top:"4rem", left:"-.3rem" },
            "d": { orient:"straight-horizontal-24d", position:{ row: 5, col: 4 } , height: ".5rem", width:"12.3rem" , top:"-.35rem", left:"-0.3rem" },
            "e": { orient:"straight-vertical-24e", position:{ row: 4, col: 7 } , height: "4.45rem", width:".5rem" , top:"-0.25rem", left:"-0.25rem" },
            "f": { orient:"horizontal-24f", position:{ row: 3, col: 6 } , height: ".5rem", width:"4.2rem", top:"3.7rem", left:"3.7rem"  },
            "g": { orient:"straight-vertical-24g", position:{ row: 2, col: 8 } , height: "6.57rem", width:".5rem" , top:"1.67rem", left:"-.2rem" },
        ...
        "26":{
            ...
            "b": { orient:"straight-vertical-26b", position:{ row: 7, col: 7} , height: "6.6rem", width:".5rem" , top:"-0.35rem", left:"-.2rem" },
        ...
        "53":{
            ...
            "b": { orient:"straight-horizontal-53b", position:{ row: 6, col: 5 } , height: ".5rem", width:"14.02rem" , top:"-.3rem", left:"0.02rem" },
            "c": { orient:"straight-vertical-53c", position:{ row: 5, col: 5 } , height: "2.05rem", width:".5rem" , top:"2.2rem", left:"-.25rem" },
            "d": { orient:"horizontal-53d", position:{ row: 5, col: 4 } , height: ".5rem", width:"1.7rem", top:"1.7rem", left:"3.7rem"  },
            },
        "60":{
            "a": { orient:"vertical-60a", position:{ row: 4, col: 1 } , height: "2rem", width:".5rem" , top:"3.75rem", left:"1.7rem" },
        ...
        "73":{
            "a": { orient:"vertical-73a", position:{ row: 2, col: 8 } , height: "2rem", width:".5rem" , top:"3.75rem", left:"1.7rem" },
            "b": { orient:"horizontal-73b", position:{ row: 3, col: 8 } , height: ".5rem", width:"2.25rem", top:"-0.3rem", left:"2rem"  },
        ...
        "75":{
            "a": { orient:"vertical-75a", position:{ row: 2, col: 6 } , height: "2rem", width:".5rem" , top:"3.75rem", left:"1.7rem" },
            "b": { orient:"horizontal-75b", position:{ row: 3, col: 6 } , height: ".5rem", width:"2.25rem", top:"-0.3rem", left:"2rem"  },
            "c": { orient:"straight-vertical-75c", position:{ row: 1, col: 7 } , height: "6.63rem", width:".5rem" , top:"1.67rem", left:"-.2rem" },
            "d": { orient:"horizontal-75d", position:{ row: 1, col: 6 } , height: ".5rem", width:"2rem", top:"1.67rem", left:"2rem"  },
        },
        "78":{
            "a": { orient:"vertical-78a", position:{ row: 2, col: 3 } , height: "2rem", width:".5rem" , top:"3.75rem", left:"1.7rem" },
